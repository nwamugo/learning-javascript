...
// what this says is that I expect some number of arguments. How many?
// I don't know. But I want to capture all of them and put them in a single array
    return numbers.reduce((sum, number) => {
        return sum + number;
    }, 0);
}
...
// calculateProduct is a lousy name, they say.
// And they ask that it is changed to multiply
// How do you go about this without breaking the code of those already
// depending on the calculateProduct name?
